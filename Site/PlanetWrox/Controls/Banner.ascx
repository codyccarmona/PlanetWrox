<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Banner.ascx.vb" Inherits="PlanetWrox.Banner" %>
<asp:Panel ID="VerticalPanel" runat="server">
    <a href="https://p2p.wrox.com" target="_blank" runat="server" id="VerticalLink">
...
<asp:Panel ID="HorizontalPanel" runat="server">
    <a href="https://p2p.wrox.com" target="_blank" runat="server" id="HorizontalLink">
