...
<asp:UpdatePanel runat="server" ID="UpdatePanel1">
  <ContentTemplate>
    <div id="TableWrapper">
      <table class="style1" runat="server" id="FormTable">
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="Name" runat="server" CssClass="InputBox" ToolTip="Enter your name"></asp:TextBox>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="EmailAddress" runat="server" CssClass="InputBox" ToolTip="Enter your e-mail address"></asp:TextBox>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="ConfirmEmailAddress" runat="server" CssClass="InputBox" ToolTip="Confirm your e-mail address"></asp:TextBox>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="PhoneHome" runat="server" CssClass="InputBox" ToolTip="Enter your home phone number"></asp:TextBox>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <asp:TextBox ID="PhoneBusiness" runat="server" CssClass="InputBox" ToolTip="Enter your business phone number"></asp:TextBox>
          </td>
          <td>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <asp:TextBox ID="Comments" runat="server" Height="78px" TextMode="MultiLine" CssClass="InputBox" ToolTip="Enter your comments"></asp:TextBox>
          </td>
          <td>
    ...
    <asp:Label ID="Message" runat="server" Text="Message Sent" CssClass="Attention" Visible="False" />
