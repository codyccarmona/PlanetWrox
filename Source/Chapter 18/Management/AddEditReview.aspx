    ...
    <Fields>
      ...
      <asp:TemplateField HeaderText="Title" SortExpression="Title">
        <EditItemTemplate>
          ...
          <asp:RequiredFieldValidator ID="reqVal1" ErrorMessage="Enter a title" ControlToValidate="TextBox1" runat="server" />
        </EditItemTemplate>
        <InsertItemTemplate>
          <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Title") %>'></asp:TextBox>
          <asp:RequiredFieldValidator ID="reqVal2" ErrorMessage="Enter a title" ControlToValidate="TextBox1" runat="server" />
        </InsertItemTemplate>
        <ItemTemplate>
      ...
      <asp:TemplateField HeaderText="Summary" SortExpression="Summary">
        <EditItemTemplate>
          ...
          <asp:RequiredFieldValidator ID="reqVal3" ErrorMessage="Enter a summary" ControlToValidate="TextBox2" runat="server" />
        </EditItemTemplate>
        <InsertItemTemplate>
          <asp:TextBox ID="TextBox2" TextMode="MultiLine" Width="500" Height="100" runat="server" Text='<%# Bind("Summary") %>'></asp:TextBox>
          <asp:RequiredFieldValidator ID="reqVal4" ErrorMessage="Enter a summary" ControlToValidate="TextBox2" runat="server" />
        </InsertItemTemplate>
        <ItemTemplate>
